...
Manuales alineados al funcionamiento actual (almacenes, SKU/botellas, ajustes) en [`docs/`](docs/):
...
Índice: [`docs/README.md`](docs/README.md). Regenerar: `python docs/build_pdf.py`.
