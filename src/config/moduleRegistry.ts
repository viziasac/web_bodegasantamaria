...
export const ALL_MODULES: ModuleDef[] = [
  ...
  { id: 'ver_stock', title: 'Inventario', icon: 'inventory_2', subtitle: 'Stock por ubicación', path: '/inventory' },
  ...
  { id: 'ajuste_inventario', title: 'Ajuste Manual', icon: 'tune', subtitle: 'Conteo físico', path: '/inventory/adjust' },
