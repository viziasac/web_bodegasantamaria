...
export const ErpRpc = {
  ...
  /** Compra + egreso opcional. Params: mismos de compra + p_registrar_gasto, p_gasto_*, p_proveedor_id */
  ...
  skuPtCrear: 'fn_sku_pt_crear',
  skuPtBootstrap: 'fn_sku_pt_bootstrap',
  skuPtBootstrapAll: 'fn_sku_pt_bootstrap_all',
