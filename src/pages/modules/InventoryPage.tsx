...
import {
  PageHeader, PageLoader, TabBar, Alert, EmptyState, StatusBadge, DataTable, fmtNum, fmtDate,
} from '../../components/ui';
...
import { TIPO_LABELS, TIPO_COLORS } from '../../components/inventory/constants';
import { useCatalog } from '../../context/CatalogContext';
import { toUserMessage } from '../../utils/erpErrors';
import type { InvStockSaldo, InventarioFila } from '../../types';
...
const InventoryPage: React.FC = () => {
  ...
  return (
    <div className="animate-in">
      <PageHeader
        title="Inventario"
        subtitle="Panorama por almacén, SKUs y stock agregado"
        action={
          ...
          {tab === 'detalle' && (
            <div className="card">
              ...
              {filasFiltered.length === 0 ? (
                <EmptyState icon="search_off" title="Sin resultados" hint="Ajuste filtros en la pestaña Panorama" />
              ) : (
