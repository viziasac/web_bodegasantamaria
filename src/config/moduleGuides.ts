...
export const MODULE_GUIDES: Record<string, ModuleGuide> = {
  ...
  recetas: {
    id: 'recetas',
    title: 'Recetas (BOM)',
    summary: 'Define los componentes por 1 botella de cada producto terminado (PT).',
    steps: [
      'Arme un BOM: elija PT y agregue materiales existentes con cantidad y UM.',
      'Ordene mentalmente: GRANEL primero, luego insumos/empaque.',
      'Edite cantidad o “variable”; puede quitar una línea o toda la receta.',
    ],
    tips: [
      'La cantidad es siempre por botella (no por pack).',
      'Al completar producción, GRANEL se valida en ALM_GR y el resto en ALM_MP.',
    ],
    related: [
